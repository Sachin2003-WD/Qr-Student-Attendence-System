...
public class BatchController {
    ...
    public ResponseEntity<ApiResponse<Batch>> createBatch(@Valid @RequestBody BatchRequest request) {
        ...
        Batch batch = Batch.builder()
                ...
                .course(course)
                .subjectName(request.getSubjectName() != null ? request.getSubjectName() : "Grooming")
                .branch(request.getBranch() != null ? request.getBranch() : "Rajajinagar Jspiders")
                .classTiming(request.getClassTiming() != null ? request.getClassTiming() : "04:45 PM")
                .trainerName(request.getTrainerName() != null ? request.getTrainerName() : "Laxman Ashok Handenavar")
