      ...
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-900 p-10 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="max-w-md space-y-4">
          ...
          <p className="text-emerald-100/90 text-sm leading-relaxed">
            Fill in your official USN, academic department, and contact details to register your student attendance account.
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-3 text-left">
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="space-y-1">
                    <Label htmlFor="sr-name" className="text-xs font-semibold">Full Name</Label>
                    <Input
                      id="sr-name"
                      required
                      value={formData.name}
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="sr-usn" className="text-xs font-semibold">USN / Roll Number</Label>
                    <Input
                      id="sr-usn"
                      required
                      value={formData.usn}
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="space-y-1">
                    <Label htmlFor="sr-email" className="text-xs font-semibold">Student Email Address</Label>
                    <Input
                      id="sr-email"
                      type="email"
                      required
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="sr-phone" className="text-xs font-semibold">Mobile Phone (10 digits)</Label>
                    <Input
                      id="sr-phone"
                      required
                      maxLength={10}
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="sr-sec" className="text-xs font-semibold">Section</Label>
                    <Input
                      id="sr-sec"
                      required
                      maxLength={2}
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="sr-dob" className="text-xs font-semibold">Date of Birth</Label>
                    <Input
                      id="sr-dob"
                      type="date"
                      required
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="space-y-1">
                    <Label htmlFor="sr-pass" className="text-xs font-semibold">Password</Label>
                    <Input
                      id="sr-pass"
                      type="password"
                      required
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="sr-cpass" className="text-xs font-semibold">Confirm Password</Label>
                    <Input
                      id="sr-cpass"
                      type="password"
                      required
